module Lich
  ...
  module DragonRealms
    ...
    # Skill to tend based on https://elanthipedia.play.net/First_Aid_skill#Skill_to_Tend
    # A 'nil' value means that can't be tended because already is tended or isn't bleeding.
    # Maps bleed rates to severity levels and related information.
    # Each entry contains:
    # - severity: Integer indicating the severity level
    # - bleeding: Boolean indicating if the wound is actively bleeding
    # - skill_to_tend: Integer indicating the skill required to tend the wound
    # - skill_to_tend_internal: Integer indicating the skill required to tend internal wounds
    ...
    # List of regular expressions to match parasite descriptions.
    ...
    # Regular expression to match body parts.
    ...
    # Maps regular expressions to wound severity levels and characteristics.
