...
# Sets the application theme preference to dark mode if the theme state is true.
# @example Setting dark theme
#   Gtk::Settings.default.gtk_application_prefer_dark_theme = true
Gtk::Settings.default.gtk_application_prefer_dark_theme = true if @theme_state == true

# Checks if there is any saved login information.
# @example Checking for saved login info
#   if @entry_data.empty?
#     # Handle no saved data
#   end
if @entry_data.empty?
  # Creates a horizontal box for layout.
  # @return [Gtk::Box] The created horizontal box.
  box = Gtk::Box.new(:horizontal)
  box.pack_start(Gtk::Label.new('You have no saved login info.'), :expand => true, :fill => true, :padding => 5)
  # Initializes the quick game entry tab as a vertical box.
  # @return [Gtk::Box] The created vertical box.
  ...
  # Checks if the tab layout state is enabled.
  # @example Checking tab layout state
  #   if @tab_layout_state == true
  #     # Handle tab layout
  #   end
  if @tab_layout_state == true

    # Initializes a notebook for account management.
    ...
    # Creates an array of unique account identifiers from entry data.
    # @return [Array] An array of unique account identifiers.
    ...
    account_array.each { |account|
      ...
      @entry_data.each { |login_info|
        ...
        # Connects the play button to an event handler for button release.
        # @example Connecting play button event
        ...
        # Connects the remove button to an event handler for button release.
        # @example Connecting remove button event
  ...
  # Initializes a horizontal pane for instance selection.
  # @return [Gtk::Paned] The created horizontal pane.
  ...
  # Creates a combo box for selecting game instances.
  # @return [Gtk::ComboBoxText] The created combo box.
...
=end
  ...
  # Initializes a toggle button for changing global GUI settings.
  # @return [Gtk::ToggleButton] The created toggle button.
  ...
  # Connects the theme select switch to an event handler for state changes.
  # @example Connecting theme select event
